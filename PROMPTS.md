...
| **VULN** | **API / URL**: como comprobar de forma simple, si esta API / URI tiene vulnerabilidades: respuestas HTTP, Autenticación (token, API key, JWT, básica), errores de DB, XSS, SQLi, SSRF, RCE, etc, ... ? |
