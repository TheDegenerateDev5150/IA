...
| **2. Escaneo de vulnerabilidades, pruebas de aplicaciones web/api y analisis** | Ejecución de herramientas (nmap NSE,Nessus,Nikto,Scripts,...) técnicas para obtener datos en bruto. Los resultados se guardan en archivos estructurados (ej. `.xml .csv .txt`). | 1.- `redaudit.sh` - Escaneos de puertos/servicios de red<br> 2.- `webaudit.sh` - Auditoría para web/API<br> 3.- `fqdnaudit.sh` - Análisis a partir de un FQDN  |
