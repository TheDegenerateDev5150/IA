...
### Legal
Este conjunto de herramientas es solo para pruebas de seguridad autorizadas . Los usuarios deben contar con la autorización escrita correspondiente antes de utilizar estos agentes en cualquier proyecto. Consulte [DOSCLAIMER.mc](https://github.com/hackingyseguridad/IA/blob/main/DISCLAIMER.md) para conocer los términos y condiciones completos.
