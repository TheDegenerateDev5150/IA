...
| 1º ──> | 2º ──> | 3º ──> | 4º ──> | 5º ──> | 6º ──> |
| :--- | :--- | :--- | :--- | :--- | :--- |
| Alcance (RECON) | Escaneo de vulnerabilidades (SCAN) | Clasifica vulnerabilidades (VULNS) | Prueba de concepto (POC) | Explota vulnerabilidades (EXPLOIT) | Informe (RPORTT) |
