...
Esta herramienta solo debe utilizarse para pruebas de seguridad legales, éticas y autorizadas. El uso no autorizado de esta herramienta en sistemas que no le pertenecen o para los que no tiene permiso explícito para realizar pruebas está estrictamente prohibido y puede infringir las normas legales y éticas.
...
Cumpla con todas las leyes y regulaciones aplicables en materia de ciberseguridad y piratería ética.
...
No utilice esta herramienta con fines maliciosos, como filtraciones de datos no autorizadas, fraude o explotación.
