...
| **3. Análisis IA de vulnerabilidades** | La IA procesa los ficheros de resultados, clasifica las vulnerabilidades por criticidad (CVSS) e identifica cuáles tienen exploit público disponible. Soporta [modo web o modo CLI](https://github.com/hackingyseguridad/IA/blob/main/INTRODUCCION.md#privacidad-de-los-datos-del-usuario-ia-modos). | **Prompt sugerido:** *"Ordena en una tabla resumen ejecutivo los puertos/servicios con vulnerabilidades CVE críticas que tengan exploit conocido y sean explotables."* |
