...
| **3. Análisis de la IA** | Procesamiento de los resultados del escaneo (`resultado.xml`) para priorizar objetivos críticos. | **Prompt:** "ordena en una tabla resumen ejecutivo, los puertos/servicios con las vulnerabilidades CVE criticas y que hay exploit, son explotables" |
