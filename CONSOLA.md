...
el tamaño del contexto y del Prompt de un formulario Web de un portal de Inteligencia artificial, **tiene un tamañao limitado**, por eso es mejor usar SKILL.md, que permite mayor escalabilidad, instrucción bajo demanda, ahorro de tokens en el prompt, mantenimiento, Recuperación inteligente (RAG) fragmentos necesarios, ..
