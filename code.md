...
[Gemini-Cli](https://www.kali.org/tools/gemini-cli/) IA Google, en el terminal (Cli) integrada en Kali Linux, con interacción sobre los dispositivos, comandos y conexion de la maquina;  Paquetes:  gemini-cli, llm-tools-nmap, mcp-kali-server.
