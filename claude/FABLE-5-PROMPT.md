...
raw: https://raw.githubusercontent.com/elder-plinius/CL4R1T4S/main/ANTHROPIC/CLAUDE-FABLE-5.md

Aplicación rápida (una sola vez)
bash
claude --dangerously-skip-permissions --system-prompt-file CLAUDE-FABLE-5.md
--system-prompt-file reemplaza el system prompt predeterminado con este archivo. El modelo sigue siendo el mismo, solo el comportamiento cambia al estilo Fable 5. Prueba a ejecutar una tarea conocida una vez con Fable y otra con Opus normal para ver las diferencias.
